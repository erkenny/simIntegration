...
typedef struct
{
	MWDSP_WAFI_GETERRCODE_FUNC   getErrorCode;
	MWDSP_WAFI_GETERRMSG_FUNC    getErrorMessage;
	MWDSP_WAFI_CREATE_FUNC       createFcn;
	MWDSP_WAFI_OUTPUTS_FUNC      outputsFcn;
	MWDSP_WAFI_TERMINATE_FUNC    terminateFcn;
	MWDSP_WAFI_SETRPTS_FUNC      setNumRepeats;
	MWDSP_WAFI_GETRPTS_FUNC      getNumRepeats;
	MWDSP_SET_RSTRT_MODE_FUNC    setRestartMode;
	MWDSP_GET_RSTRT_MODE_FUNC    getRestartMode;
	MWDSP_WAFI_FRST_SAMPLE_FUNC  justOutputFirstSamp;
	MWDSP_WAFI_LAST_SAMPLE_FUNC  justOutputLastSamp;
} MWDSP_Wafi_FunctionPtrStruct;
#define MWDSP_WAFI_NUM_FUNCTIONS 11
...
void MWDSP_Wafi_Outputs(const void * obj, void* signal);
