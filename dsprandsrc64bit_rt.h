 ...
 *  $Revision: 1.1.6.3 $ $Date: 2005/12/22 18:02:47 $
 */
 ...
 */
DSPRANDSRC64BIT_EXPORT void MWDSP_RandSrcInitState_U_64(
 ...
 * state   = 35*nChans real64_T elements
 */
DSPRANDSRC64BIT_EXPORT void MWDSP_RandSrc_U_D(
 ...
 */
#ifdef CREAL_T
DSPRANDSRC64BIT_EXPORT void MWDSP_RandSrc_U_Z(
 ...
 */
DSPRANDSRC64BIT_EXPORT void MWDSP_RandSrc_GZ_D(
 ...
 */
#ifdef CREAL_T
DSPRANDSRC64BIT_EXPORT void MWDSP_RandSrc_GZ_Z(
 ...
 * MWDSP_RandSrcInitState_U_64
 */
DSPRANDSRC64BIT_EXPORT void MWDSP_RandSrcInitState_GC_64(
    const uint32_T *seeds,
    real64_T       *state,
    int_T           nChans);
 ...
 */
DSPRANDSRC64BIT_EXPORT void MWDSP_RandSrc_GC_D(
    real64_T *y,       const real64_T *mean,
    int_T     meanLen, const real64_T *xstd,
 ...
 */
#ifdef CREAL_T
DSPRANDSRC64BIT_EXPORT void MWDSP_RandSrc_GC_Z(
    creal64_T *y,       const creal64_T *mean,
    int_T      meanLen, const real64_T *xstd,
    int_T      xstdLen, real64_T       *state,
    int_T      nChans,  int_T           nSamps,
 ...
 */
DSPRANDSRC64BIT_EXPORT void MWDSP_RandSrcCreateSeeds_64(
    uint32_T  initSeed,
    uint32_T *seedArray,
    uint32_T  numSeeds);
