/************************ dSPACE target specific file *************************
   ...
   Include file .\sd_jf_median_rti1103\SD_jf_median_th.c :

   Task Configuration file for model : SD_jf_median

   RTI1103 6.4 (03-Dec-2009)/2.2
   28-Feb-2017 20:02:00
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\sd_jf_median_rti1103\SD_jf_median_th.c is for ST).
# endif
