/*
 *  DSPFBSUB_RT Runtime functions for DSP Blockset
 *  Forward/Backward Substitution block.
 *
 *  Solves LX = B(UX=B) where L(U) is a lower(upper)
 *  (or unit-lower(upper)) triangular matrix.
 *
 *  Copyright 1995-2005 The MathWorks, Inc.
 *  $Revision: 1.4.4.5 $  $Date: 2006/02/14 20:25:54 $
 *
 */
 ...
 *    RD - complex L or U with real non-unit diagonal 
...
#ifdef CREAL_T
DSPFBSUB_EXPORT void MWDSP_BSub_RD_ZD_Z(
        const creal_T *pU,
        const real_T  *pb,
              creal_T  *x,
        const int_T     N,
...
#ifdef CREAL_T
DSPFBSUB_EXPORT void MWDSP_BSub_RD_ZZ_Z(
        const creal_T *pU,
        const creal_T *pb,
              creal_T  *x,
        const int_T     N,
...
#ifdef CREAL_T
DSPFBSUB_EXPORT void MWDSP_BSub_RD_CC_C(
        const creal32_T *pU,
        const creal32_T *pb,
              creal32_T  *x,
        const int_T       N,
...
#ifdef CREAL_T
DSPFBSUB_EXPORT void MWDSP_BSub_RD_CR_C(
        const creal32_T *pU,
        const real32_T  *pb,
              creal32_T  *x,
        const int_T       N,
...
#ifdef CREAL_T
DSPFBSUB_EXPORT void MWDSP_FSub_RD_ZD_Z(
        const creal_T *pL,
        const real_T  *pb,
              creal_T  *x,
        const int_T     N,
...
#ifdef CREAL_T
DSPFBSUB_EXPORT void MWDSP_FSub_RD_ZZ_Z(
        const creal_T *pL,
        const creal_T *pb,
              creal_T  *x,
        const int_T     N,
...
#ifdef CREAL_T
DSPFBSUB_EXPORT void MWDSP_FSub_RD_CC_C(
        const creal32_T *pL,
        const creal32_T *pb,
              creal32_T  *x,
        const int_T       N,
...
#ifdef CREAL_T
DSPFBSUB_EXPORT void MWDSP_FSub_RD_CR_C(
        const creal32_T *pL,
        const real32_T  *pb,
              creal32_T  *x,
        const int_T       N,
...
#  include "dspfbsub/bsub_rd_cc_c_rt.c"
#  include "dspfbsub/bsub_rd_cr_c_rt.c"
#  include "dspfbsub/bsub_rd_zd_z_rt.c"
#  include "dspfbsub/bsub_rd_zz_z_rt.c"
...
#  include "dspfbsub/fsub_rd_cc_c_rt.c"
#  include "dspfbsub/fsub_rd_cr_c_rt.c"
#  include "dspfbsub/fsub_rd_zd_z_rt.c"
#  include "dspfbsub/fsub_rd_zz_z_rt.c"
# endif /* CREAL_T */
