/************************ dSPACE target specific file *************************
   ...
   Include file .\sd_jf_mg_back_stride_rti1103\SD_jf_mg_back_stride_th.c :

   Task Configuration file for model : SD_jf_mg_back_stride

   RTI1103 6.4 (03-Dec-2009)/2.2
   12-Feb-2017 17:44:27
...
# include <RTI1103\C\rti_th_aux.c>
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\sd_jf_mg_back_stride_rti1103\SD_jf_mg_back_stride_th.c is for ST).
# endif
