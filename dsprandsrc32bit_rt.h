 ...
 *  $Revision: 1.1.6.3 $ $Date: 2005/12/22 18:02:44 $
 */
 ...
 * state   = 35*nChans real32_T elements
 */
DSPRANDSRC32BIT_EXPORT void MWDSP_RandSrc_U_R(
 ...
 */
#ifdef CREAL_T
DSPRANDSRC32BIT_EXPORT void MWDSP_RandSrc_U_C(
 ...
 */
DSPRANDSRC32BIT_EXPORT void MWDSP_RandSrc_GZ_R(
 ...
 */
#ifdef CREAL_T
DSPRANDSRC32BIT_EXPORT void MWDSP_RandSrc_GZ_C(
 ...
 * MWDSP_RandSrcInitState_U_32
 */
DSPRANDSRC32BIT_EXPORT void MWDSP_RandSrcInitState_GC_32(
 ...
 */
DSPRANDSRC32BIT_EXPORT void MWDSP_RandSrc_GC_R(
    real32_T *y,       const real32_T *mean,
    int_T     meanLen, const real32_T *xstd,
 ...
 */
#ifdef CREAL_T
DSPRANDSRC32BIT_EXPORT void MWDSP_RandSrc_GC_C(
    creal32_T *y,       const creal32_T *mean,
    int_T      meanLen, const real32_T  *xstd,
    int_T      xstdLen, real32_T        *state,
    int_T      nChans,  int_T            nSamps,
 ...
 */
DSPRANDSRC32BIT_EXPORT void MWDSP_RandSrcCreateSeeds_32(
    uint32_T  initSeed,
    uint32_T *seedArray,
    uint32_T  numSeeds);
