...
*
*  @copyright
*    Copyright 1993-2007, dSPACE GmbH. All rights reserved.
*
*  @version
*    $RCSfile: Dstypes.h $ $Revision: 1.16 $ $Date: 2009/01/26 11:34:55GMT+01:00 $
*    $ProjectName: e:/ARC/Products/ImplSW/RTLibSW/RTLib1103/Develop/DS1103/DSTYPES.pj $
*
*   <hr><br>
*<!-------------------------------------------------------------------------->*/
...
#if defined _DSHOST || defined _MSC_VER || defined __TURBOC__ || defined __UNIX__ || defined(MATLAB_MEX_FILE) || defined(DS_PLATFORM_HN)
...
#ifdef DS_PLATFORM_HN
/* host node software requires 64bit types (tbd: may remove restriction and
   allow 64bit types for all Host applications) */
...
#elif defined _DS1005 || defined _DS1103 || defined _DS1104 || defined _DS1401 || defined _603 || defined _603e || defined _604 || defined _604e || defined _565 || defined _RP565 || defined _DS1602
