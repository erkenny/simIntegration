/*
 * dspmmutils_rt.h Header file for utilities that provide conversion routines
...
#ifdef DSPMMUTILS_EXPORTS
#  define DSPMMUTILS_EXPORT EXPORT_FCN
#else
#  define DSPMMUTILS_EXPORT MWDSP_IDECL
#endif
...
DSPMMUTILS_EXPORT COPY_RGB24_FUNC         MWDSP_GetRGB24CopyFcn(VideoDataType dType);
DSPMMUTILS_EXPORT COPY_RGB24_CHANS_FUNC   MWDSP_GetRGB24ChannelsCopyFcn(VideoDataType dType);
DSPMMUTILS_EXPORT COPY_RGB24_FUNC         MWDSP_GetRGB24EmptyFcn(VideoDataType dType);
DSPMMUTILS_EXPORT COPY_RGB24_CHANS_FUNC   MWDSP_GetRGB24ChannelsEmptyFcn(VideoDataType dType);

DSPMMUTILS_EXPORT OUTPUT_RGB24_FUNC       MWDSP_GetRGB24OutputFcn(VideoDataType dType);
DSPMMUTILS_EXPORT OUTPUT_RGB24_CHANS_FUNC MWDSP_GetRGB24ChannelsOutputFcn(VideoDataType dType);

DSPMMUTILS_EXPORT OUTPUT_RGB24_FUNC       MWDSP_GetPaddedRGB24OutputFcn(VideoDataType dType);
DSPMMUTILS_EXPORT OUTPUT_RGB24_CHANS_FUNC MWDSP_GetPaddedRGB24ChannelsOutputFcn(VideoDataType dType);

DSPMMUTILS_EXPORT COPY_RGB24_FUNC         MWDSP_GetRGB24ToIntensityCopyFcn(VideoDataType dType);
DSPMMUTILS_EXPORT COPY_RGB24_FUNC         MWDSP_GetIntensityEmptyFcn(VideoDataType dType);
...
DSPMMUTILS_EXPORT COPY_PCM_SAMPLES_FUNC   MWDSP_GetPCMAudioCopyFcn(AudioDataType dType, int_T numBits);
DSPMMUTILS_EXPORT COPY_PCM_SAMPLES_FUNC   MWDSP_GetPCMAudioEmptyFcn(AudioDataType dType);
DSPMMUTILS_EXPORT OUTPUT_PCM_SAMPLES_FUNC MWDSP_GetPCMAudioOutputFcn(AudioDataType dType, int_T numBits);
