/*********************** dSPACE target specific file *************************
   ...
   Include file SD_jf_mg_back_stride_rti.c:
...
#define RTB_STRUCTURE_NAME             SD_jf_mg_back_stride_B
#define RTP_STRUCTURE_NAME             SD_jf_mg_back_stride_P

/* dSPACE generated includes for header files */
#include <DS1103\brtenv.h>
#include <DS1103\RTKernel\rtkernel.h>
#include <RTI1103\C\rti_assert.h>
#include <RTI1103\C\rtidefineddatatypes.h>
...
__INLINE void rti_mdl_sample_input(void)
{
  ...
  /* dSPACE I/O Board DS1103 #1 Unit:MultiAdc */
  {
    ...
    SD_jf_mg_back_stride_B.SFunction_g[0] = pvalues[8];
    SD_jf_mg_back_stride_B.SFunction_g[1] = pvalues[9];
    SD_jf_mg_back_stride_B.SFunction_g[2] = pvalues[10];
    SD_jf_mg_back_stride_B.SFunction[0] = pvalues[12];
    SD_jf_mg_back_stride_B.SFunction[1] = pvalues[13];
    SD_jf_mg_back_stride_B.SFunction[2] = pvalues[14];
  }
}
